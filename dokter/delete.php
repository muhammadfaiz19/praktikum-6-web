...
<body class="bg-gray-100 p-6">
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="flex items-center mb-4">
            ...
            <h2 class="text-xl font-semibold">Delete Data Dokter</h2>
        </div>
        <hr class="mb-4"/>
        ...
        <form name="formDelete" method="POST" action="">
            ...
            <dl class="row mt-1">
                <?php foreach ($rows as $row): ?>
                    ...
                    <dt class="col-sm-3 font-medium text-gray-700">NIP:</dt>
                    <dd class="col-sm-9"><?php echo $row['nip']; ?></dd>
                    ...
                    <dt class="col-sm-3 font-medium text-gray-700">Spesialis:</dt>
                    <dd class="col-sm-9"><?php echo $row['spesialis']; ?></dd>

                    <dt class="col-sm-3 font-medium text-gray-700">Tempat Praktek:</dt>
                    <dd class="col-sm-9"><?php echo $row['tempat_praktek']; ?></dd>
                <?php endforeach; ?>
            </dl>

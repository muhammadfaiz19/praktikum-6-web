...
<body class="bg-gray-100 p-6">
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="flex items-center mb-4">
            ...
            <h2 class="text-xl font-semibold">Delete Data Obat</h2>
        </div>
        <hr class="mb-4"/>
        ...
        <form name="formDelete" method="POST" action="">
            ...
            <dl class="row mt-1">
                <?php foreach ($rows as $row): ?>
                    ...
                    <dt class="col-sm-3 font-medium text-gray-700">Kode Obat:</dt>
                    <dd class="col-sm-9"><?php echo $row['kode_obat']; ?></dd>

                    <dt class="col-sm-3 font-medium text-gray-700">Nama Obat:</dt>
                    <dd class="col-sm-9"><?php echo $row['nama_obat']; ?></dd>

                    <dt class="col-sm-3 font-medium text-gray-700">Produsen:</dt>
                    <dd class="col-sm-9"><?php echo $row['produsen']; ?></dd>

                    <dt class="col-sm-3 font-medium text-gray-700">Bentuk:</dt>
                    <dd class="col-sm-9"><?php echo $row['bentuk']; ?></dd>

                    <dt class="col-sm-3 font-medium text-gray-700">Berat:</dt>
                    <dd class="col-sm-9"><?php echo $row['berat']; ?></dd>
                <?php endforeach; ?>
            </dl>
